...
export const popularProduct = {
	props: ['bgUrl', 'hrefBuy', 'title', 'sale', 'basicPrice', 'oldPrice', 'hotPrice'],
	...
	`<div class="popular__item">
		<div class="popular__item-image" :style='["background-image: url(" + bgUrl + ")"]'><h3 v-if='sale' class="popular__item-sale">Акция</h3></div>
