...
export const popular = {
	...
	`<section class="popular wrapper">
		...
		<div class="popular__items">
			<popularProduct
				imageUrl = '_popular/images/pop-product-bg1.png'
				hrefBuy = '#'
			...
			<popularProduct
				imageUrl = '_popular/images/pop-product-bg2.png'
				hrefBuy = '#'
				title = 'Гранитный щебень 5-20мм'
				sale = 'true'
				basicPrice = ''
			...
			<popularProduct
				imageUrl = '_popular/images/pop-product-bg3.png'
				hrefBuy = '#'
			...
			<popularProduct
				imageUrl = '_popular/images/pop-product-bg4.png'
				hrefBuy = '#'
				title = 'Гранитный щебень 5-20мм'
				sale = ''
				basicPrice = '1 350 р./т'
